(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-tradedatepicker', ['exports', '@angular/common', '@angular/forms', '@angular/core'], factory) :
    (factory((global['angular-tradedatepicker'] = {}),global.ng.common,global.ng.forms,global.ng.core));
    ...
    ***************************************************************************** */
    ...
    var UtilService = /** @class */ (function () {
         ...
         */
            function (dateStr, options, validateOpts) {
                ...
                try {
                    ...
                    try {
                        if (dateValues_1_1 && !dateValues_1_1.done && (_a = dateValues_1.return))
                            _a.call(dateValues_1);
                    }
                    finally {
                        if (e_1)
                            throw e_1.error;
            ...
            function (dateStr, dateFormat, delimeters) {
                ...
                if (delimeters) {
                    try {
                        ...
                        try {
                            if (delimeters_1_1 && !delimeters_1_1.done && (_a = delimeters_1.return))
                                _a.call(delimeters_1);
                        }
                        finally {
                            if (e_2)
                                throw e_2.error;
            ...
            function (date, options) {
                ...
                if (!result) {
                    ...
                    try {
                        ...
                        try {
                            if (inputDates_1_1 && !inputDates_1_1.done && (_a = inputDates_1.return))
                                _a.call(inputDates_1);
                        }
                        finally {
                            if (e_3)
                                throw e_3.error;
                ...
                if (disableWeekdays.length > 0) {
                    try {
                        ...
                        try {
                            if (disableWeekdays_1_1 && !disableWeekdays_1_1.done && (_b = disableWeekdays_1.return))
                                _b.call(disableWeekdays_1);
                        }
                        finally {
                            if (e_4)
                                throw e_4.error;
         ...
         */
            function (date, dates) {
                ...
                try {
                    ...
                    try {
                        if (dates_1_1 && !dates_1_1.done && (_a = dates_1.return))
                            _a.call(dates_1);
                    }
                    finally {
                        if (e_5)
         ...
         */
            function (date, enableDates) {
                ...
                try {
                    ...
                    try {
                        if (enableDates_1_1 && !enableDates_1_1.done && (_a = enableDates_1.return))
                            _a.call(enableDates_1);
                    }
                    finally {
                        if (e_6)
                            throw e_6.error;
         ...
         */
            function (date, enableDates) {
                ...
                try {
                    ...
                    try {
                        if (enableDates_2_1 && !enableDates_2_1.done && (_a = enableDates_2.return))
                            _a.call(enableDates_2);
                    }
                    finally {
                        if (e_7)
                            throw e_7.error;
         ...
         */
            function (dateBegin, dateEnd, enableDates) {
                ...
                try {
                    ...
                    try {
                        if (enableDates_3_1 && !enableDates_3_1.done && (_a = enableDates_3.return))
                            _a.call(enableDates_3);
                    }
                    finally {
                        if (e_8)
                            throw e_8.error;
         ...
         */
            function (dateBegin, dateEnd, disableDateRanges) {
                ...
                try {
                    ...
                    try {
                        if (disableDateRanges_1_1 && !disableDateRanges_1_1.done && (_a = disableDateRanges_1.return))
                            _a.call(disableDateRanges_1);
                    }
                    finally {
                        if (e_9)
                            throw e_9.error;
         ...
         */
            function (date, labeledDates) {
                var e_10, _a, e_11, _b;
                try {
                    for (var labeledDates_1 = __values(labeledDates), labeledDates_1_1 = labeledDates_1.next(); !labeledDates_1_1.done; labeledDates_1_1 = labeledDates_1.next()) {
                    ...
                    try {
                        if (labeledDates_1_1 && !labeledDates_1_1.done && (_a = labeledDates_1.return))
                            _a.call(labeledDates_1);
                    }
                    finally {
                        if (e_10)
                            throw e_10.error;
         ...
         */
            function (date, options) {
                ...
                try {
                    ...
                    try {
                        if (markDates_1_1 && !markDates_1_1.done && (_a = markDates_1.return))
                            _a.call(markDates_1);
                    }
                    finally {
                        if (e_12)
    ...
    var DayViewComponent = /** @class */ (function () {
        function DayViewComponent(utilService) {
            ...
            this.viewActivated = new core.EventEmitter();
    ...
    var FooterBarComponent = /** @class */ (function () {
        function FooterBarComponent(utilService) {
            this.utilService = utilService;
            this.footerBarTxtClicked = new core.EventEmitter();
        ...
        FooterBarComponent.propDecorators = {
            opts: [{ type: core.Input }],
            footerBarTxtClicked: [{ type: core.Output }]
        };
    ...
    var AngularMyDatePickerCalendarDirective = /** @class */ (function () {
        ...
        AngularMyDatePickerCalendarDirective.propDecorators = {
            libAngularMyDatePickerCalendar: [{ type: core.Input }]
        };
    ...
    exports.AngularMyDatePickerModule = AngularMyDatePickerModule;
    exports.AngularMyDatePickerDirective = AngularMyDatePickerDirective;
    ...
    exports.AngularMyDatePickerCalendarDirective = AngularMyDatePickerCalendarDirective;
    ...
    exports.CalAnimation = CalAnimation;
    ...
    exports.PIPE = PIPE;
    exports.YEAR_SEPARATOR = YEAR_SEPARATOR;
    exports.SU = SU;
    exports.MO = MO;
    exports.TU = TU;
    exports.WE = WE;
    ...
    exports.OPTS = OPTS;
    exports.YEARS_DURATION = YEARS_DURATION;
    exports.YEARS = YEARS;
    ...
    exports.ANIMATION_END = ANIMATION_END;
    exports.ANIMATION_TIMEOUT = ANIMATION_TIMEOUT;
    exports.MY_DP_ANIMATION = MY_DP_ANIMATION;
    exports.ANIMATION_NAMES = ANIMATION_NAMES;
    exports.IN = IN;
    exports.OUT = OUT;
    exports.TABINDEX = TABINDEX;
    exports.TD_SELECTOR = TD_SELECTOR;
    exports.PREVENT_CLOSE_TIMEOUT = PREVENT_CLOSE_TIMEOUT;
    exports.ɵa = FooterBarComponent;
    exports.ɵb = TenorsComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=angular-tradedatepicker.umd.js.map